...
export function MainScene({
  ...
  const PortalMaterial = shaderMaterial(
    {
      ...
      uColorEnd: new THREE.Color('#FF98F8')
    },
    portalVertexShader,
  ...
  useFrame((_, delta) => {
    ...
    portalMaterial.current.uColorStart = new THREE.Color(colorStart)
    portalMaterial.current.uColorEnd = new THREE.Color(colorEnd)
  })
