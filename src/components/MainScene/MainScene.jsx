...
export function MainScene({
  ...
  const PortalMaterial = shaderMaterial(
    {
      uTime: 0,
      uColorStart: new THREE.Color('#d1c1e5'),
      uColorEnd: new THREE.Color('#ebe7ef')
    },
    portalVertexShader,
  ...
  return (
    <group {...rest} dispose={null}>
      ...
      <Sparkles
        size={20}
        scale={[2, 2, 2]}
        position={[nodes.diglette1.position.x, nodes.diglette1.position.y + 1.0, nodes.diglette1.position.z]}
        speed={1.5}
        count={6}
      />
      ...
      <Sparkles
        size={20}
        scale={[2, 2, 2]}
        position={[nodes.diglette2.position.x, nodes.diglette2.position.y + 1.0, nodes.diglette2.position.z]}
        speed={1.5}
        count={6}
      />
      ...
      <Sparkles
        size={20}
        scale={[2, 2, 2]}
        position={[nodes.diglette3.position.x, nodes.diglette3.position.y + 1.0, nodes.diglette3.position.z]}
        speed={1.5}
        count={6}
      />
      ...
      <Sparkles
        size={20}
        scale={[2, 2, 2]}
        position={[nodes.diglette4.position.x, nodes.diglette4.position.y + 1.0, nodes.diglette4.position.z]}
        speed={1.5}
        count={6}
      />
    </group>
